...
createVert.addEventListener('click', function(){postit1.createPostit()});

let createRouge = document.getElementById('postitRouge');
createRouge.addEventListener('click', function(){postit2.createPostit()});

let createBleu = document.getElementById('postitBleu');
createBleu.addEventListener('click', function(){postit3.createPostit()});
